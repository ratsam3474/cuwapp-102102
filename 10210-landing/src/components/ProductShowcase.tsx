  ...
  return (
    <div className="bg-black text-white bg-gradient-to-b from-black to-[#5D2CA8] py-[72px] sm:py-24">
      <div className="container">
        ...
        <p className="text-xl text-white/70 text-center mt-5 ">Packed Features - Our engine is packed with powerful features to supercharge your WhatsApp marketing. Send up to 3000 messages per day with advanced automation and personalization.</p>
        </div>
