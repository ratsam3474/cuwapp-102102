...
# Database configuration - Use the API database
# Check if we're in admin directory, use the API database
API_DB_PATH = "/Users/JE/Documents/102102/10210-api/data/wagent.db"
LOCAL_DB_PATH = "data/wagent.db"

# Use API database if it exists and has data
